...
const Navbar = () => {
  ...
  return (
    <nav className="py-4 bg-gray-50 shadow-sm sticky top-0 z-50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div 
          className={cn(
            "md:hidden absolute top-full left-0 right-0 bg-gray-50 shadow-md transform transition-transform duration-200 ease-in-out z-30",
